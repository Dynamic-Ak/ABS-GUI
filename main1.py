...
root.configure(background='gold',borderwidth=5,  highlightthickness=5, highlightcolor="blue") #bg colour
...
#button:1
b2=Button(root,text='Snake Game',bg='red',fg='yellow',font='LCDMono2 18 ', \
    relief=RIDGE,command=program4)
b2.grid(row=0,column=2, padx=10,pady=10)
#button:2
b3=Button(root,text='GUI Notepad',bg='yellow',fg='magenta2',font='LCDMono2 18 ', \
    relief=RIDGE,command=program3)
b3.grid(row=1,column=2, padx=10,pady=10)
#button:3
b1=Button(root,text='News letter',bg='springgreen3',fg='black',font='LCDMono2 18 ', \
    relief=RIDGE,command=program2)
b1.grid(row=2,column=2, padx=10,pady=10)
#button:4
b4=Button(root,text='GUI Calculator',bg='purple',fg='white',font='LCDMono2 18 ', \
    relief=RIDGE,command=program)
b4.grid(row=3,column=2, padx=10,pady=10)
#button:5
b5=Button(root,text='Registration Form',bg='pink',fg='blue',font='LCDMono2 18 ', \
...
#time 
label=Label(root,font=('LCDMono2',18),bg='gold',fg='brown4')
